...
class StateEngagementMap extends Component {
  ...
  async componentDidMount() {
    ...
    const current_result = await get_db('twitter_sentiments_1', 'http://shibachan:MuchWOWSuchAmAzE@172.26.131.162:5984/').query('sentiments/locations_neg_stats', query_option);
    const history_result = await get_db('twitter_sentiments_3', 'http://shibachan:MuchWOWSuchAmAzE@172.26.131.162:5984/').query('sentiments/locations_neg_stats', query_option);
