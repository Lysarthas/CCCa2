...
class StateSentimentCountMap extends Component {
  ...
  async componentDidMount() {
    ...
    const current_result = await get_db('twitter_sentiments_1', 'http://shibachan:MuchWOWSuchAmAzE@172.26.131.132:5984/').query('sentiments/locations_neg_count', query_option);
    const history_result = await get_db('twitter_sentiments_2', 'http://shibachan:MuchWOWSuchAmAzE@172.26.131.132:5984/').query('MuchWOWSuchAmAzE/locations_neg_count', query_option);
